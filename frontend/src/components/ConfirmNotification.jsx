        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-bg-secondary rounded-xl shadow-xl p-8 max-w-md w-full">
                ...
                <div className="flex justify-end gap-4">
                    <button
                        className="px-5 py-2 rounded bg-bg-tertiary text-text-primary font-semibold hover:bg-bg-secondary transition"
                        onClick={onCancel}
                    >
                        Cancel
                    </button>
                    <button
                        className="px-5 py-2 rounded bg-error text-text-white font-semibold hover:bg-error-deep transition"
                        onClick={onConfirm}
                    >
                        {confirmLabel}
                    </button>
