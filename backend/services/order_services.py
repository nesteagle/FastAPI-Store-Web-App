...
from ..routers.utils import try_get_user, try_get_order, get_order_details, add_order_items
...
def update_order_service(order_id: int, order_data: OrderCreate, db: Session) -> Dict[str, Any]:
